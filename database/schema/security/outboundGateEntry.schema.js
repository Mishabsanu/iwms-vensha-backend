...
const OutboundGateEntrySchema = new mongoose.Schema({
  date: {
    type: String,
...
const OutboundGateEntryModel = mongoose.model("OutboundGateEntry", OutboundGateEntrySchema);

export default OutboundGateEntryModel;
